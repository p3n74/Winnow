...
export function augmentWithSemanticInference(
  ...
  for (const n of baseNodes) {
    ...
    addNode({
      ...
      descriptionEn: "Represents a likely business or execution workflow inferred from function naming.",
      detailLevel: "L1",
  ...
  for (const def of conceptDefs) {
    ...
    addNode({
      ...
      descriptionEn: "Represents a cross-file theme inferred from directory and file placement.",
      detailLevel: "L1",
